...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        init: function() {
            ...
            this.$elem.addClass(this.options.strengthClass).attr('data-password',thisid).after('</a><div class="'+this.options.strengthMeterClass+'"><div  data-meter="'+thisid+'"><p id="WeekOrNot"></p></div></div>');
