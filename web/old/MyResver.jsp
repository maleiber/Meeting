...
<div>
    <br><br><br>
    <p style="text-align:center;font-size: larger" class=" col-xs-2 ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;个人中心->我的预定</p>
...
<script type="text/javascript">
    function operateFormatter(value, row, index) {
        return [
            '<button type="button" class="RoleOfC btn btn-default  btn-sm" data-toggle="modal" data-target="#myModal">查看/撤销</button>',
